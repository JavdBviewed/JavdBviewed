...
describe('repository identity', () => {
  it('derives every GitHub repository endpoint from the migrated owner and repository', () => {
    ...
    expect(RELEASE_REPO_NAME).toBe('JavdBviewed-release');
    expect(RELEASE_REPO_SLUG).toBe('JavdBviewed/JavdBviewed-release');
    expect(REPO_URL).toBe('https://github.com/JavdBviewed/JavdBviewed');
    expect(REPO_RELEASES_URL).toBe('https://github.com/JavdBviewed/JavdBviewed-release/releases');
    expect(REPO_RELEASES_LATEST_URL).toBe('https://github.com/JavdBviewed/JavdBviewed-release/releases/latest');
    expect(REPO_ISSUES_URL).toBe('https://github.com/JavdBviewed/JavdBviewed/issues');
    expect(REPO_API_RELEASES_URL).toBe('https://api.github.com/repos/JavdBviewed/JavdBviewed-release/releases');
